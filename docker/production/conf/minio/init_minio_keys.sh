...
mc admin user svcacct add --access-key $MINIO_ACCESS_KEY --secret-key $MINIO_SECRET_KEY --expiry 2024-12-20T10:00 --name $MINIO_NAME $MINIO_ALIAS $MINIO_USER